      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-display text-2xl font-semibold text-foreground">{authenticated ? "Pro plan" : "Free preview"}</p>
            </div>
          </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-medium text-foreground">{authenticated ? "72% of Pro allowance" : "4 of 20 free analyses used"}</span>
          </div>
        </div>
        <div className="rounded-3xl border border-border/70 bg-white/70 p-4 dark:bg-white/[0.03]">
          <div className="flex items-center gap-3">
            <Sparkles className="h-5 w-5 text-brand" />
            <p className="text-sm text-foreground">Unlock faster exports, queue priority, and team billing when you move to Pro.</p>
          </div>
        </div>
